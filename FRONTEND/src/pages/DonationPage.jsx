...
//                 <p><strong>Amount spent:</strong> ${milestone.amountSpent} USD</p>
//               </li>
//             ))}
//           </ul>
//         ) : (
...
const DonationPage = () => {
  ...
  //   // Show the campaign URL to the user via a toast notification
  //   toast.info(`Campaign URL: ${campaignUrl}`, {
  ...
  const handleShareClick = () => {
    ...
    // Copy the campaign URL to the clipboard
    navigator.clipboard.writeText(campaignUrl).then(() => {
      // Show a success toast notification when the URL is copied
      toast.success("Campaign URL copied to clipboard!", {
        autoClose: 5000,
      });
    }).catch((err) => {
      // Show an error toast notification if there was an issue copying the URL
  ...
  return (
    <div>
      ...
      {/* <div className="campaign-url">
        ...
        <a href={`http://localhost:5000/campaign/${activeCampaignId}`} target="_blank" rel="noopener noreferrer">
          {`http://localhost:5000/campaign/${activeCampaignId}`}
        </a>
      </div> */}
